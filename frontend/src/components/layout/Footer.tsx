    ...
    return (
        <footer className="border-t bg-card">
            <div className="container mx-auto px-4 py-6 text-center text-sm text-muted-foreground">
                <p>
                    &copy; {new Date().getFullYear()} UCourseHub. This tool has no affiliation with the University of Alberta and Rate my Professors, and is just a personal project.
                </p>
            </div>
